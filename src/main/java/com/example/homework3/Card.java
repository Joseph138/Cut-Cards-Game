...
Date: 3/14/2023
Attribute: Card back photo- Tyler the Creator Flower Boy album cover, Joker logo:http://www.clipartbest.com/batman-joker-logo, Code Dr. Lutz
 */
...
public class Card implements Comparable<Card> {
    ...
    public Card() {
        String cardBack = IMGS_PREFIX + (color == Color.WHITE ? "card_back.png": "card_back.png");
        this.image = new Image(cardBack);
        return;
    }
